...
###build up CaseNames, RunDirs, Archive Dirs, etc.
    ...
    CaseName=$JG_CaseName_Root"$t"_no_calving
...
###copy in temporary test where ice fluxes are completely turned off
    cp -vf $D/SourceMods/glc_import_export.F90 SourceMods/src.cism
